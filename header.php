...
<body <?php body_class(); ?>>
    ...
    <header class="section header">
        ...
        <?php if ( ! is_home() ) { ?>
                  <a itemprop="url" href="<?php echo home_url( '/' ); ?>" title="<?php echo esc_attr( $defaultoptions['default_text_title_home_backlink'] ); ?>" rel="home" class="logo">
              <?php } ?>
              <h1><img itemprop="logo" src="<?php echo esc_url( wp_make_link_relative(get_header_image()) ); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>"></h1>
