	...
	if ($search->have_posts() ) {
         ...
         if (  $wp_query->max_num_pages > 1 ) { ?>
                <div class="archiv-nav">
                    ...
                    if ($page>1) {
                        echo '<li class="prev">';
                        echo '<a href="'.esc_url(get_pagenum_link(1)).'">'.__( '&larr; First page', 'piratenkleider' ).'</a>';
                        echo "</li>\n";
                    }
                    echo '<li class="pages">';
                    ...
                    if ($page < $last) {
                        ...
                        echo '<li class="next">';
                        echo '<a href="'.esc_url(get_pagenum_link($last)).'">'.__( 'Last page &rarr;', 'piratenkleider' ).'</a>';
                        echo "</li>\n";
                    }
                    ?>
                </ul></div>
         <?php
                        ...
                        <p>
                            <?php _e("Alternatively try the following links:", 'piratenkleider'); ?>
